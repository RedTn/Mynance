module.exports = {
  ...
  rules: {
    ...
    */
    ...
    'new-cap': [1, { newIsCap: true, capIsNew: true, capIsNewExceptions: ['A'] }], // optionally set `[2, {"capIsNewExceptions": ["Person"]}]`
    'new-parens': 1,
    ...
    */
    ...
    'max-len': [2, 100, 4], // `[2, 80, 4]` is default, optionally set `[2, 80, 4, {"ignoreComments": true, "ignoreUrls": true}]`
